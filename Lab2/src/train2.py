...
def main():
    ...
    parser.add_argument('-content_dir', type=str, required=False, default="./../datasets/COCO100/")
    parser.add_argument('-style_dir', type=str, required=False, default="./../datasets/wikiart100/")
    parser.add_argument('-gamma', type=float, required=False, default=0.9)
    parser.add_argument('-e', type=int, required=False, default=20)
    parser.add_argument('-b', type=int, required=False, default=8)
    parser.add_argument('-l', type=str, required=False, default="encoder.pth")
    parser.add_argument('-s', type=str, required=False, default="decoder.pth")
    parser.add_argument('-p', type=str, required=False, default="loss_plot.png")
    parser.add_argument('-cuda', type=str, required=False, default='Y')
    ...
    device = None
    print(f"use_cuda.lower(): {use_cuda.lower()}")
